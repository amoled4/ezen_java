...
public class 정리 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 1. 변수
		 * - 일반변수(지역변수, 기본형 변수) : 값을 저장하는 기본 메모리 공간 확보
		 ...
		 * - 논리연산자 ( &&, ||, ! )
		 *   - && : and 여러 개의 조건이 모두 맞아야 true  ~이고, ~면서
		 *   - || : or 여러 개의 조건 중 하나만 맞아도 true  ~이거나, ~또는
		 *   - ! : not 현재 조건의 반대
		 * - 증감연산자 ( ++, -- )
		 ...
		 *  - switch : 값이 나오는 식, 변수
		 *    - 반드시 하나의 case가 끝나면 break문을 달아줘야 함
