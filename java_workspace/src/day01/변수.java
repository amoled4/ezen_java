...
public class 변수 {
	...
	public static void main(String[] args) {
		...
		// 변수 : 리터럴값을 담는 메모리 공간
		// 주석 - 한줄 주석 : 코드에 영향을 미치지 않는 구문, 설명을 위해 사용
		/* 여러줄
		 * 주석입니다. */
		// 변수 선언 방법
		// 변수타입 변수명;
		...
		System.out.println("num1의 값 : "+num1 +  ", a의 값 : "+a);
		...
		// 일반적인 class는 객체를 만들어서 객체로 사용. String은 워낙 자주 사용하다보니, 자료형처럼 사용 가능.
		String str = "abc";  // 문자열
		...
		// 기본 실수형은 double로 인식
		// float형의 실수값은 접미사 f F를 반드시 써야 함.
		float f = 1.234f;
